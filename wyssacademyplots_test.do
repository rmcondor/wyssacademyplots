********************************************************************************
** 	TITLE: wyssacademyplots_test.do
**
**	PURPOSE: This scheme is an input for Wyss Academy for Nature's data visualizations
**
**
...
* Set wyssacademyplots scheme

set scheme wyssacademyplots, perm

*** Scatter plot
twoway (scatter var2 var5), title("Scatter plot") note("Elaboration: Wyss Academy for Nature")
graph export "${graphs}\scatter_plot.png",  name("Graph") replace
...
graph export "${graphs}\line_graph.png",  name("Graph") replace
...
graph export "${graphs}\pie_chart.png",  name("Graph") replace

*** Box plot
graph box var1 - var5 , ///
		title("Box plot") ///
		note("Elaboration: Wyss Academy for Nature")
graph export "${graphs}\box_plot.png",  name("Graph") replace

*** Histogram
histogram var3, percent title("Histogram") note("Elaboration: Wyss Academy for Nature")
graph export "${graphs}\histogram.png",  name("Graph") replace
...
graph hbar var1 - var5, ///
		...
		title("Bar graph") ///
		note("Elaboration: Wyss Academy for Nature")
graph export "${graphs}\hbar.png",  name("Graph") replace
...
graph export "${graphs}\density.png",  name("Graph") replace
...
graph export "${graphs}\range_graphs.png",  name("Graph") replace
...
graph export "${graphs}\bygraphs.png",  name("Graph") replace
